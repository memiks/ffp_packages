...
Ejabberd 3.0 mobile reliability layer helps manage mobile network‚
...
The purpose of encoding video data is to reduce redundancies ‚Äì that means to 
...
./ImageMagick/DESCR
===
ImageMagickÆ is a software suite to create, edit, compose, or convert 
...
./glib/DESCR
===
GLib fournit les √©l√©ments applicatifs de base pour les biblioth√®ques et 
les applications √©crites en C. Elle fournit le syst√®me central des 
objets employ√©s dans GNOME, l'impl√©mentation de la boucle principale, 
ainsi qu'un vaste ensemble de fonctions utilitaires pour le traitement 
des cha√Ænes et d'autres structures de donn√©es courantes. 
